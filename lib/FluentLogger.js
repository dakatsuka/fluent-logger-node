...
var FluentLogger = function(options) {
  this.options = options || {};
  this.port = this.options.port || 24224;
  this.host = this.options.host || '127.0.0.1';
  this.tagPrefix = this.options.tagPrefix || null;
  this.bufferSize = this.options.bufferSize || 10000;
...
FluentLogger.prototype.post = function(tag, data) {
  tag = this.tagPrefix ? this.tagPrefix + "." + tag : tag
...
exports.createLogger = function(options) {
  return new FluentLogger(options);
};
